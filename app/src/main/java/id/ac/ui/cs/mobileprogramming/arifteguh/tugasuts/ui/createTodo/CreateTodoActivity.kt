...
class CreateTodoActivity : AppCompatActivity() {
    ...
    private fun prePopulateData(todoRecord: TodoRecord) {
        ...
        form_tanggal_dd_1.setText(todoRecord.tanggal)
        form_waktu_hh_1.setText(todoRecord.jam)
    ...
    private fun saveTodo() {
        if (validateFields()) {
            ...
            val todo = TodoRecord(id = id, title = et_todo_title.text.toString(),
                tanggal = form_tanggal_dd_1.text.toString(),
                jam = form_waktu_hh_1.text.toString(),
